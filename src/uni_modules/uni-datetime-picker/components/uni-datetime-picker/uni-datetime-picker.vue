      ...
      <slot>
        <view class="uni-date-editor--x" :class="{ 'uni-date-editor--x__disabled': disabled, 'uni-date-x--border': border }">
          <view v-if="!isRange" class="uni-date-x uni-date-single">
            ...
            <input class="uni-date__x-input" type="text" v-model="displayValue" :placeholder="singlePlaceholderText"
              :disabled="true" />
          </view>

          <view v-else class="uni-date-x uni-date-range">
            <uni-icons class="icon-calendar" type="calendar" color="#c0c4cc" size="22"></uni-icons>
            <input class="uni-date__x-input t-c" type="text" v-model="range.startDate" :placeholder="startPlaceholderText"
              :disabled="true" />
    ...
    <view v-if="!isPhone" v-show="pickerVisible" ref="datePicker" class="uni-date-picker__container">
      <view v-if="!isRange" class="uni-date-single--x" :style="popover">
        ...
        <view v-if="hasTime" class="uni-date-changed popup-x-header">
          ...
          <time-picker type="time" v-model="pickerTime" :border="false" :disabled="!inputDate" :start="reactStartTime"
        ...
        <calendar ref="pcSingle" :showMonth="false" :start-date="caleRange.startDate" :end-date="caleRange.endDate"
          :date="calendarDate" @change="singleChange" style="padding: 0 8px;" />
